    ...
    fr: {
        ...
        values: {
            ...
            items: [
                {
                    title: 'Précision',
                    description: "Chaque pixel, chaque ligne de code est réfléchie pour atteindre un niveau d'excellence technique irréprochable.",
                },
                {
                    title: 'Scalabilité',
                    description: "Des architectures pensées pour évoluer avec votre croissance, sans compromis sur les performances.",
                },
                {
                    title: 'Esthétique',
                    description: "Un design premium qui marie fonctionnalité et beauté, pour une identité visuelle mémorable.",
                },
            ],
        },
        testimonials: {
    ...
    ar: {
        ...
        services: {
            ...
            items: [
                ...
                },
                {
                    title: 'تصميم SaaS',
                    description:
                        "تصميم منتجات SaaS تتمحور حول المستخدم، بنهج موجه نحو التحويل وأنظمة تصميم متطورة.",
                },
            ],
        },
        process: {
            ...
            steps: [
                ...
                {
                    title: 'التطوير',
                    description: "هندسة متقدمة باستخدام أحدث التقنيات لمنتج قوي وسريع.",
                },
                {
                    title: 'الإطلاق',
        ...
        values: {
            ...
            items: [
                {
                    title: 'الدقة',
                    description: "كل بكسل، كل سطر كود مدروس لبلوغ مستوى تميز تقني لا تشوبه شائبة.",
                },
                {
                    title: 'قابلية التوسع',
                ...
                {
                    title: 'الجماليات',
                    description: "تصميم متميز يمزج بين الوظيفة والجمال لهوية بصرية لا تُنسى.",
                },
            ],
        },
        testimonials: {
